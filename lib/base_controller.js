...
require("@utkusarioglu/object-assist");
...
class BaseController {
    constructor(controller_scope) {
        this._monologue_emitter = new events_1.EventEmitter().setMaxListeners(20);
        this._dialogue_emitter = new events_1.EventEmitter().setMaxListeners(20);
    ...
    request(scope, sender_namespace, recipient_namespace, talk, group) {
        ...
        const request_channel = recipient_namespace +
            c_controller_1.C_Controller.DIALOGUE_SEPARATOR +
            group;
        const response_channel = request_channel +
            c_controller_1.C_Controller.ID_SEPARATOR +
            service_id;
    ...
    announce(scope, sender_namespace, recipient_namespace, talk, delay = false) {
        ...
        const announcement_channel = recipient_namespace +
            c_controller_1.C_Controller.MONOLOGUE_SEPARATOR +
            expression_trail;
