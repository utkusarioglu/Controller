...
test("App_Controller", () => {
    controller_1.Controller.flush_GlobalController();
    const manager = new sample_controller_events_class_1.SampleControllerEventsClass("App");
    const child1 = new sample_controller_events_class_1.SampleControllerEventsClass("App/Child");
