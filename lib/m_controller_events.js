...
class M_ControllerEvents {
    ...
    initialize_Controller() {
        this.set_Controller();
        this.announce_ToAllServices.bind(this, c_controller_1.C_BootState.ClassReady),
            this.get_Controller()
    ...
    announce_LibraryAdded(library_source_namespace) {
        this.get_Controller().announce(t_controller_1.e_Scope.Global, c_controller_1.C_Controller.AllServices, [...c_controller_1.C_BootState.LibraryAdded, [library_source_namespace]], true);
    }
}
