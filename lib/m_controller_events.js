...
class M_ControllerEvents {
    ...
    initialize_Controller() {
        this.set_Controller();
        setTimeout(this.announce_ToAllServices.bind(this, C_BootState.ClassReady), c_controller_1.C_Controller.GraceTime);
        this.get_Controller()
            .wait(t_controller_1.e_Scope.Global, c_controller_1.C_Controller.AllServices, C_StartupTalk.run_Listen, undefined, () => {
            this.register_Dependencies();
            this.register_Subscriptions();
            this.announce_ToAllServices(C_BootState.ListenReady);
        });
        this.get_Controller()
            .wait(t_controller_1.e_Scope.Global, c_controller_1.C_Controller.AllServices, C_StartupTalk.run_Talk, undefined, () => {
    ...
    announce_ToAllServices(resolution_instruction) {
        this.get_Controller().announce(t_controller_1.e_Scope.Global, c_controller_1.C_Controller.AllServices, resolution_instruction, true);
    }
    announce_LibraryAdded(library_source_namespace) {
        this.get_Controller().announce(t_controller_1.e_Scope.Global, c_controller_1.C_Controller.AllServices, [...C_BootState.LibraryAdded, [library_source_namespace]], true);
    }
}
