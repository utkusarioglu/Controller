...
export class M_ControllerEvents {
    ...
    announce_ToAllServices(resolution_instruction) {
        this.get_Controller().announce(e_Scope.Global, C_Controller.AllServices, resolution_instruction, true);
    }
    announce_LibraryAdded(library_source_namespace) {
        this.get_Controller().announce(e_Scope.Global, C_Controller.AllServices, [...C_BootState.LibraryAdded, [library_source_namespace]], true);
    }
}
